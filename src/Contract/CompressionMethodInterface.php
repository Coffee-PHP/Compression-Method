...
/**
 * CompressionMethodInterface.php
 *
 ...
 * @since 2020-09-09
 */
interface CompressionMethodInterface extends
    PathCompressionMethodInterface,
    DirectoryCompressionMethodInterface,
    FileCompressionMethodInterface,
    StringCompressionMethodInterface,
    CompressorInterface,
    UncompressorInterface
{
}
